...
def main_win():
    ...
    bg = PhotoImage(file = r"C:\Users\magesh\Downloads\StegMed-main\StegMed-main\Test Images\RGB Images\JPEG Images\Mountain.jpg")   # The file parameter takes path which isn't associated or present in project directory.
